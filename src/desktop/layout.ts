export const DESK_LAYOUT = {
  ...
  keyboard: {
    inputX: { start: 0.2, end: 0.7 },
    inputY: { start: 0.48, end: 0.82 },
    x: { start: -0.95, end: -0.2 },
    z: { start: 1.82, end: 2.34 },
    y: 0.54,
    dragLift: 0.16,
  },
  mouse: {
    inputX: { start: 0.66, end: 0.93 },
    inputY: { start: 0.35, end: 0.72 },
    x: { start: 2.65, end: 4.72 },
    z: { start: 1.22, end: 3.02 },
    y: 0.63,
    body: { radius: 0.55, scale: { x: 0.84, y: 0.38, z: 1.2 }, position: { x: 0.05, y: -0.05, z: 0.02 } },
    rearHump: { radius: 0.45, scale: { x: 0.82, y: 0.46, z: 0.96 }, position: { x: 0.04, y: 0.02, z: 0.2 } },
    clickDeck: { size: { width: 0.64, height: 0.035, depth: 0.4 }, radius: 0.075, position: { x: 0.03, y: 0.115, z: -0.34 } },
    clickSeam: { size: { width: 0.018, height: 0.012, depth: 0.32 }, radius: 0.006, position: { x: 0.03, y: 0.14, z: -0.34 } },
    centerSpine: { size: { width: 0.1, height: 0.055, depth: 0.46 }, radius: 0.035, position: { x: 0.03, y: 0.17, z: -0.19 } },
    wheel: { radius: 0.07, height: 0.12, rotationZ: Math.PI / 2, position: { x: 0.03, y: 0.23, z: -0.28 } },
    dpiButton: { size: { width: 0.1, height: 0.045, depth: 0.15 }, radius: 0.03, position: { x: 0.03, y: 0.19, z: -0.02 } },
    sideButtons: { size: { width: 0.05, height: 0.075, depth: 0.13 }, radius: 0.02, x: -0.43, y: 0.035, z: [-0.07, 0.12] },
    logo: {
      position: { x: 0.04, y: 0.2, z: 0.32 },
      stem: { size: { width: 0.025, height: 0.018, depth: 0.12 }, radius: 0.008, x: -0.035 },
      bars: [
        { size: { width: 0.095, height: 0.018, depth: 0.022 }, radius: 0.007, position: { x: 0.005, y: 0, z: -0.045 } },
        { size: { width: 0.075, height: 0.018, depth: 0.022 }, radius: 0.007, position: { x: 0.005, y: 0, z: 0 } },
        { size: { width: 0.095, height: 0.018, depth: 0.022 }, radius: 0.007, position: { x: 0.005, y: 0, z: 0.045 } },
      ],
    },
  },
